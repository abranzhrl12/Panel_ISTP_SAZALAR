// src/features/home/pages/UserCreationPage.tsx
// Esta página permite a los usuarios con rol de administrador crear nuevas cuentas de usuario.

import React, { useState } from "react";
import { useCreateUser } from "@features/user-management/hooks/useCreateUser"; // Importa el hook para crear usuarios
import {
  type CreateUserInput,
  CreateUserInputSchema,
} from "@features/user-management/services/user-management.schemas"; // Importa el tipo de entrada y esquema
    ...
    <div className="p-6 bg-white shadow-md rounded-lg max-w-lg mx-auto mt-10">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {/* formErrors.role (si existe, ajusta a formErrors.roleId si el esquema lo valida) */}
          {/* {formErrors.role && (
